---
description: Implementa las tareas del cambio por olas paralelas, con evidencia y sin tocar los artefactos aprobados. Usar cuando el usuario pide construir, implementar o codificar las tareas.
---
...
- `satlas trace --change $ARGUMENTS` sin errores y `satlas status` en "construyendo" (o "aprobado/planificado").
