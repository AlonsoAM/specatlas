---
description: Revisión de código con lentes por tamaño del diff y verificación adversarial de hallazgos. Usar cuando el usuario pide revisar el código antes del PR.
---
...
4. Escribe `.sdd/changes/$ARGUMENTS/review.md`: hallazgos con severidad, evidencia, decisión y estado.
