---
description: Resuelve supuestos, dependencias y preguntas abiertas de un cambio ya especificado antes de aprobar y planificar. Usar cuando el usuario pide aclarar, resolver dudas o cerrar preguntas abiertas de una especificación.
---
...
Resolver los supuestos, dependencias y preguntas abiertas del cambio `$ARGUMENTS` y dejarlos registrados en `.sdd/changes/$ARGUMENTS/clarify.md`.
El contenido se escribe en **español**.

## Pasos

1. Lee `.sdd/changes/$ARGUMENTS/spec.md`, `proposal.md` y, si existe, `clarify.md`.
...
7. Cierra con `satlas clarify $ARGUMENTS` (estado de la aclaración) y `satlas next $ARGUMENTS`.
