...
- `prompts/satlas-clarify.md` — Aclarar: Resuelve supuestos, dependencias y preguntas abiertas de un cambio ya especificado antes de aprobar y planificar. Usar cuando el usuario pide aclarar, resolver dudas o cerrar preguntas abiertas de una especificación.
- `prompts/satlas-docs.md` — Documentar: Genera la documentación técnica y manual del cambio (carril completo) desde la evidencia registrada. Usar cuando el usuario pide documentar, generar el manual o cerrar la documentación antes de archivar.
